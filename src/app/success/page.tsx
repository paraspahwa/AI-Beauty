    ...
    <div
      ...
      style={{
        background: isStudioPro
          ? "linear-gradient(145deg, #fffafc 0%, #fffafc 50%, #fffafc 100%)"
          : "linear-gradient(145deg, #fffafc 0%, #fffafc 50%, #fffafc 100%)",
      }}
    >
      <motion.div
      ...
      >
        ...
        <motion.ul variants={staggerContainer} className="text-left space-y-3 mb-8">
          {perks.map((perk, i) => (
            ...
            >
              <CheckCircle2 className="h-5 w-5 shrink-0 mt-0.5" style={{ color: isStudioPro ? "#111827" : "#111827" }} />
        ...
        <motion.div variants={fadeUp} className="space-y-4">
          <Button asChild variant="accent" size="lg" className="w-full group"
            style={isStudioPro ? { background: "#111827", border: "none" } : undefined}
          >
