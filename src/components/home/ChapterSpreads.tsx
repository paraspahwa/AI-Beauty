...
function buildChapters(): Chapter[] {
  ...
  return [
    ...
    },
    {
      ...
      pullQuote: "Wardrobe direction from your full-body photo — analyzed after you unlock.",
      body: "Upload a full-body image after your Full Report, unlock the add-on, and Renovaara analyzes your silhouette to build essentials, accents, and a separate PDF.",
      imageSrc: "/1779024309.png",
      imageAlt: "Renovaara Style Guide wardrobe infographic",
      tags: ["Full-body upload", "Pay then analyze", "Separate PDF", "After unlock"],
      imageLeft: true,
    },
  ];
}
