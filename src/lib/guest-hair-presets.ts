...
export const GUEST_HAIR_PRESETS: Record<string, { hair_color: FalHairColor; hairstyle: string }> = {
  hair: { hair_color: "natural", hairstyle: "layered" },
  blonde: { hair_color: "blonde", hairstyle: "long_hair" },
  brunette: { hair_color: "dark_brown", hairstyle: "medium_long_hair" },
  auburn: { hair_color: "auburn", hairstyle: "wavy_hair" },
  burgundy: { hair_color: "red", hairstyle: "bob_cut" },
};

export function resolveGuestHairParams(variant?: string): { hair_color: FalHairColor; hairstyle: string } {
